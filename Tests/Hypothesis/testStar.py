...
class testStar(unittest.TestCase):
    ...
    @example('0101 000000000000000 f72110b-1     00 317TbjkYG3u}(f)                     G          -    A 000   01')
    @example('2040    JH*U1CnPh(Gtg00 ???????-? 11222[aQg)V]111             -  -  A 000   00 2}iK')
    @example('0140 000000000000000 ???????-? 0000000000000 0       - - A 000  100 00')
    @example('0940      ouV)anTg*V0QDeNL  ???????-? ]naJy2GDuB{hq8qG -   -  [ouJB]  -  XFX      X01   11')
    @example('0101 000000000000000 ???????-? B 0000000000000       - - A 000   --0')
    @example('0205 b9N00077          ???????-? B                               -  * A       ?E3     --B1n')
    @example('0101 000000000000000 ???????-? B 0000000000000       - - A 000   --00')
    ...
    @example('0140 000000000000000 A000000-0 F 0000000000000       C     - F   000   00')
    @example('0940  ouV)anT-eB00111    A111110-X RH?xJy Hcb-O-a}   ov4111111         EBCCH    -    B   2FA    070R')
    @example('0940 ouV)anT-eB00111 ?11111A-X ?HHJOR-- abcxy}  1         BCCE - B 001   00R')
    @example('0140 000000000000000 A000000-0 00 0000000  + 0 00         - A   000    00')
    @example('0140 000000000000000 ???????-? 0000000000000 0       De *       A  ?00   00')
    @example('0140 000000000000000 ???????-? [00r0MOW0 mw}]C          BB     - A   000   00')
    @example('0140 000000000000000 ???????-? 0000000000000 C          BB     B A   000   00')
    @example('0101 000000000000000 ???????-? 000000000000000       De     - A  ?00   00')
    @example('0140 ]00111111111111  ???????-?  111111111111111 -   -   [0100]    -    010   010')
    @example('0101 000000000000000 ???????-? [000000000000](       - - A 000   00)')
    @example('0101 000000000000000 ???????-? [000000000000]X       - - A 000   00)')
