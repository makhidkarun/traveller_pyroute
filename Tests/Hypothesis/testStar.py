...
class testStar(unittest.TestCase):
    ...
    @example('0101 000000000000000 ?000000-0 000000000000000 {0} (000-0) [0000] - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 0000000000000 0       - - 0 000   00 D')
    ...
    @example('0101 000000000000000 ???????-? 000000000000000       - -         0   000   00')
    @example('0101 000000000000000 ???????-? 00000000000000000000000000000000000000       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000000000 {0} (000-0)  - - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000000000       -       - 0   000   00 D')
    @example('0101 000000000000000 ???????-? (0000000000000000000000000000000000000       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 0000000000 0000 {0} (000-0)  - - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 0000000000000000000000000000000000000)       - - 0 000   00 D')
    @example('0101 000000000000000 A000000-I 000000000000000       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000000000000000000000000000000()       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? [0000000000000000000000000000000000000       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? {0000000000000000000000000000000000000       - - 0 000   00 D')
    @example('0110 000000000000000 ???????-? 000000000000000 {0} (000-0)  -  Bc - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000 A0000 {0} (000-0)  - - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000000000       - - 0 000   00000 0 0 D')
    @example('1717 Vland                A967A9A-F Hi Cs [Vilani]            { 3 }  (D9F+5) [CD7H] BEFG N  - 310 7  ImDv F8 V           ')
    @example('0101 000000000000000 ???????-? (000000000000000000000000000000000000)       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 00000000000000( {1} (000-0)  -         - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000000000 {0 } -       -   - 0 000   00 D')
    @example('0110 000000000000000 ???????-? 000000000000000 {1} -   - -         - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 00000000000000( {1 } (000-0)  -  -         - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 00000000000000( { 1} (000-0)  -  -       - 0   000   00 D')
    @example('0000 000000000000000 ???????-? 0000000000000 0 {0} -       -   - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 00000000000000( { +0 } (000-0)  -         - 0 000   00 D')
    ...
    @example('0101 000000000000000 ???????-? 00000000000000( { 1 } (000-0) [0000] -       - 0   000   00 D')
    @example('2405 Uurku                B986445-9 Ni Pa (Ashdak Meshukiiba) Sa          { 0 }  (A33-2) [2437] Bc   -  - 222 8  ImDv K1 V')
    @example('0101 000000000000000 ???????-? 000000000000000       - - 0 000   0000V D')
    @example('0110 000000000000000 ???????-? 00000000000000( {1} (000-0)       -   - 0 000   00 D')
    @example('0000 000000000000000 ???????-? 000000000000 {}       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 00000000000 { }       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000(0) 00       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? (0)000000000 00       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 00000000000(0)0       - - 0 000   00 D')
    @example('0101 000000000000000 ???????-? 000000000000( )       - - 0 000   00 D')
    ...
    @example('3135                      ?478???-?                                     - - - ?02   Na D')
    @example('0310                      ?776???-?                                     - - - ?03   Kk        D')
    ...
    @example('1732                      ?AFA???-? Fl Wa                               - - - ?13   Na D       ')
    ...
    @example('0810                      ?124???-F                                     - - - ?03   Kk D')
    @example('0401                      ?342???-B Po                                  - - - ?14   Kk D       ')
    @example('1204 Barnett 0404         E756???-1 Ga Lt (minor)                         - - A 401   Na G9 V                 ')
    @example('0101 Raktegham            C529767-?                                      - K - 921   K3 D       ')
    @example('0403 Kirrughee            C110314-? Lo                                   - O - 223   K3 D       ')
