...
def comparison_line(draw):
    rejects = [
        ...
        '0000 000000000000000 0000000-0 (0 000000000)0?       - - 0 000    0?',
        '0000 000000000000000 0000000-0 000000000000000 {0} (000-0)       -    - 0 000   ?0',
        '0000 000000000000000 0000000-0 (00000000000)0) {0} -  [0000] - - 0 000   0?',
        '0000 000000000000000 ???????-? 000000000000 [0       - - 0 000   ?0]',
    ...
    # Assume out strings which are definitely unparseable at the moment
    if ']' in candidate[-10:] or ')' in candidate[-10:]:
        assume(False)
...
class testHypothesisStarlineParser(unittest.TestCase):
    ...
    @example('0000 000000000000000 ???????-? 000000000000000 {  0} (000-0) [0000]   - 0   000   00?', True)
    @example('0000 000000000000000 ???????-? (000000000?  0)       - - 0 000    0?', True)
    @example('0000 000000000000000 0000000-0 000000000000000 {  0} -  [0000]   - 0 000   00?', True)
    @example('0101 000000000000000      ???????-?                                       { -2 } -       -      BCDEFG -  - 000 0  00                                                           ', True)
    @example('0101 000000000000000 ???????-? 000 0000000BCDEFG       - - 0 000   00', True)
    @example('0101 000000000000000 ???????-? 000000000000000       - - 0 000   10 +', True)
    @example('0000 000000000000000 ???????-? 000000000000000         -   000   A00', True)
    @example('0101 000000000000000 ???????-? 000000000000000         -   001   000', True)
    @example('0000 000000000000000 0000000-0 000000000000000       - - a 000    ?0', True)
    @example('0101 000000000000000 ???????-? 000000000000000 {0} (000-0) [0000]   - a   000   00', True)
    @example('0101 000000000000000 ???????-? 000000000000000       a -   000   00', True)
    @example('0000 000000000000000 ???????-? 000000000000000       - - A 000   000 000-0 ', True)
    @example('0101 000000000000000 ???????-? 00000000000+  0         - a 000   00', True)
    ...
    @example('0000 000000000000000 0000000-0 (0 000000000)0?       - - 0 000    0?', False)
    @example('0000 000000000000000 0000000-0 000000000000000 {0} (000-0)       -    - 0 000   ?0', False)
    @example('0000 000000000000000 0000000-0 (00000000000)0) {0} -  [0000] - - 0 000   0?', False)
    @example('0000 000000000000000 ???????-? 00000000000000   00       - - A 000   00?', False)
    @example('0000 000000000000000 ???????-? 000000000000000       - - A 000   --0', False)
    @example('0000 000000000000000 ???????-? 000000000 [0 ]A       - - A 000    ?0', False)
    # Weird parsing cases
    @example('0000 000000000000000 ???????-? (00000000000000       - - 0 000   00?)', 'weird')
    @example('0000 000000000000000 ???????-? [00000000000000       - - 0 000   00?]', 'weird')
    @example('0000 000000000000000 ???????-? [00000000000000       - - 0 000   ?0]', 'weird')
    @example('0000 000000000000000 0000000-0 (00000000000000       - - 0 000   00?)', 'weird')
    @example('0000 000000000000000 0000000-0 [00000000000000       - - 0 000   00?]', 'weird')
    @example('0000 000000000000000 0000000-0 [00000000000000       - - 0 000   ?0]', 'weird')
    @example('0000 000000000000000 ???????-? 000000000000 [0       - - 0 000   ?0]', 'weird')
    @example('0000 000000000000000 0000000-0 000000000000 [0       - - 0 000   ?0]', 'weird')
    @example('0000 000000000000000 ???????-? 000000000000 (0       - - 0 000   ?0)', 'weird')
    @example('0000 000000000000000 0000000-0 000000000000 (0       - - 0 000   ?0)', 'weird')
