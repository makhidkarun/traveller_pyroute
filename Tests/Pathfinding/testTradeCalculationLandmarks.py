...
class testTradeCalculationLandmarks(baseTest):
    ...
    def test_landmarks_on_ibara_subsector_multiple_components(self):
        ...
        self.assertEqual("Dorevann (Zarushagar 0708)", str(landmarks[1][0]), "Unexpected landmark choice")
        self.assertEqual("Shadishi (Zarushagar 0310)", str(landmarks[1][2]), "Unexpected landmark choice")
