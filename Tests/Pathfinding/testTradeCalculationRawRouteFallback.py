...
class testTradeCalculationRawRouteFallback(baseTest):

    def test_overflow_under_trade_calculation_raw_routes_fallback(self) -> None:
        sourcefile = self.unpack_filename('DeltaFiles/overflow_under_trade_calculation_raw_routes/Zarushagar.sec')
        ...
        galaxy.trade.raw_ranges = TradeCalculationRawRoutes(galaxy.trade)
