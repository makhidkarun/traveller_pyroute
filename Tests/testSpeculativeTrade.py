...
class testSpeculativeTrade(baseTest):
    def test_spec_trade_across_TL(self):
        ...
        cases = [
            ('?000000-0', ['As'], '?000000-1', ['As', 'De'], "CT", 3000, 3000),
            ('?000000-0', ['As'], '?000000-1', ['As', 'De'], "T5", 3000, 3000)
        ]
    ...
    def test_spec_trade_same_TL_no_codes(self):
        ...
        cases = [
            ('?000000-0', [], '?000000-0', [], "CT", 2000, 2000),
            ('?000000-0', [], '?000000-0', [], "T5", 2000, 2000)
        ]
    ...
    def test_spec_trade_same_TL_with_codes(self):
        ...
        cases = [
            ('?000000-0', ['Ag'], '?000000-0', ['In'], "CT", 4000, 4000),
            ('?000000-0', ['Ag'], '?000000-0', ['In'], "T5", 4000, 4000)
        ]
