...
class OldMap(object):
    ...
    def document(self, sector, is_live: bool = True) -> Any:
        """
    ...
    def add_circle(self, doc, center, radius, colorname) -> None:
        """
    ...
    def subsector_grid(self, doc) -> None:
