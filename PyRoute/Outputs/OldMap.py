...
class OldMap(object):
    ...
    def cursor(self, x, y) -> None:
        """
        create a cursor (position) element
        """
        raise NotImplementedError("Base Class")

    def sector_name(self, doc, name) -> None:
        """
        Write name at the top of the document
        """
        raise NotImplementedError("Base Class")

    def coreward_sector(self, doc, name) -> None:
        raise NotImplementedError("Base Class")

    def rimward_sector(self, doc, name) -> None:
        raise NotImplementedError("Base Class")

    def spinward_sector(self, doc, name) -> None:
        raise NotImplementedError("Base Class")

    def trailing_sector(self, doc, name) -> None:
        raise NotImplementedError("Base Class")

    def add_line(self, doc, start, end, color) -> None:
        """
        Add a line to the document, from start to end, in color
        """
        raise NotImplementedError("Base Class")

    def add_circle(self, doc, center, colorname) -> None:
        """
    ...
    @staticmethod
    def string_width(font, string) -> None:
        raise NotImplementedError("Base Class")

    def place_system(self, doc, star) -> None:
        """
        Write a single world information into the map
        """
        raise NotImplementedError("Base Class")

    def write_sector_pdf_map(self, gal_sector, is_live=True) -> None:
        raise NotImplementedError("Base Class")
    ...
    def write_base_map(self, doc, sector) -> None:
    ...
    def subsector_grid(self, doc, sector) -> None:
    ...
    def draw_borders(self, pdf, sector) -> None:
        self.sector = sector
        self.hex_grid(pdf, self._draw_borders, 1.5, 'salmon')

    @staticmethod
    def convert_hex_to_axial(row, col) -> tuple[int, int]:
        x = row
        z = col - (row - (row & 1)) / 2
        return (x, z)
